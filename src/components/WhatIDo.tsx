        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Predictive Intelligence & Systems</h4>
              <p>
                ML specialist building systems to predict and analyze complex data, from churn prediction to machinery health using state of the art models.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Shipping Scalable APIs</h4>
              <p>
                I build the systems behind it: structuring backend functionality, API creation, and ensuring logic handles large amounts of data.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
